...
<div class="card">
    ...
    <div class="card-body row mt-2 pb-1">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card bg-gray-lt">
                <div class="card-header py-2">
                    <img src="<?php echo e($d['image']); ?>" class="rounded text-truncate text-small py-1 mr-2" alt="Own Offerwall" height="36px">
                    <h3 class="card-title text-dark text-truncate"><?php echo e($d['name']); ?></h3>
                    <div class="card-actions">
                        <a href="<?php echo e(route('networks_cpa_edit', ['id' => $d['of_id']])); ?>">
                            Edit configuration
        ...
        <div class="col-lg-4 col-md-6 col-12 pb-4">
            <a href="<?php echo e(route('networks_cpa_new')); ?>" class="card bg-gray-lt h-100 mb-0 pt-2 justify-content-center align-self-center text-center">
                <span>
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\1-websites\wp.mintservice.ltd\resources\views/admin/networks_cpa.blade.php ENDPATH**/ ?>