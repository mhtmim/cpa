...
<?php endif; ?>
<div class="row">
    <form class="col-xl-4 col-md-5 col-sm-12" action="<?php echo e(route('gateway_category_add')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card">
            ...
            <div class="card-body pt-2 row">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Amazon Gift Card" value="<?php echo e(old('name')); ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="input_desc" placeholder="Enter your email address to receive the gift card" value="<?php echo e(old('input_desc')); ?>">
                </div>
                <div class="mb-3">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="country" placeholder="Amazon GC" value="<?php echo e(old('country')); ?>">
                </div>
            </div>
    ...
    <div class="col-lg-8 col-md-7 col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card">
                    <a href="<?php echo e(route('gateway', ['id' => $c->id])); ?>" class="d-block bg-gray-lt">
                    ...
                    <div class="btns">
                        ...
                        <a href="#" class="btn-edit" data-id="<?php echo e($c->id); ?>" data-name="<?php echo e($c->name); ?>" data-desc="<?php echo e($c->input_desc); ?>" data-ty="<?php echo e($c->input_type); ?>" data-typ="<?php echo e(['','Text','Email','Number'][$c->input_type]); ?>" data-ct="<?php echo e($c->country == 'all' ? '' : $c->country); ?>" data-toggle="modal" data-target="#cat-edit" data-backdrop="static" data-keyboard="false">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <div class="fixed-img-bottom w-100">
                        <div class="h4 text-center"><?php echo e($c->name); ?></div>
                    </div>
                </div>
            </div>
...
<form method="post" action="<?php echo e(route('gateway_category_del')); ?>" class="modal modal-blur fade" id="cat-del" tabindex="-1" role="dialog" aria-hidden="true">
    <?php echo csrf_field(); ?>
...
<form method="post" action="<?php echo e(route('gateway_category_edit')); ?>" enctype="multipart/form-data" class="modal modal-blur fade" id="cat-edit" tabindex="-1" role="dialog" aria-hidden="true">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\1-websites\wp.mintservice.ltd\resources\views/admin/gateway_category.blade.php ENDPATH**/ ?>