...
<form method="post" class="row" action="<?php echo e(route('push_msg_send')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="col-md-6 col-lg-4">
        <div class="mb-3">
            ...
            <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                        ...
                        <div class="lh-sm">
                            ...
                            <div class="form-check-description">
                                <div class="input-group">
                                    <input id="sendtype-1-input" type="text" name="email_or_userid" class="form-control" <?php if(isset($data['direct'])): ?> value="<?php echo e($data['uid']); ?>" readonly <?php else: ?> value="<?php echo e(old('email_or_userid')); ?>" <?php endif; ?> aria-label="Enter Email or User ID">
                                    <input class="form-control" id="sendtype-1-val" type="hidden" name="email_or_userid_type" value="1">
                                    <button type="button" id="sendtype-1-text" class="btn btn-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" <?php if(isset($data['direct'])): ?> readonly <?php endif; ?>>User ID</button>
                ...
                <label class="form-selectgroup-item flex-fill">
                    <input id="sendtype-2-radio" type="radio" name="sendtype" value="2" class="form-selectgroup-input" <?php if(isset($data['direct'])): ?> disabled <?php endif; ?>>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                        <div class="mr-3">
                            <span class="form-selectgroup-check"></span>
                        </div>
                ...
                <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="sendtype" value="3" class="form-selectgroup-input" <?php if(isset($data['direct'])): ?> disabled <?php endif; ?>>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                        <div class="mr-3">
                            <span class="form-selectgroup-check"></span>
                        </div>
                ...
                <label class="form-selectgroup-item flex-fill">
                    <input type="radio" name="sendtype" value="4" class="form-selectgroup-input" <?php if(isset($data['direct'])): ?> disabled <?php endif; ?>>
                    <div class="form-selectgroup-label d-flex align-items-center p-3">
                        <div class="mr-3">
                            <span class="form-selectgroup-check"></span>
                        </div>
    ...
    <div class="col-md-6 col-lg-8">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="title" value="<?php echo e(old('title')); ?>" placeholder="Enter a title...">
        </div>
            ...
            <div class="col-6">
                ...
                <div class="form-selectgroup mr-3">
                    <label class="form-selectgroup-item">
                        <input type="radio" name="text_or_multi" value="1" class="form-selectgroup-input" <?php echo e(old('text_or_multi', '1') == '1' ? 'checked' : ''); ?>>
                        <span class="form-selectgroup-label">Text</span>
                    </label>
                    <label class="form-selectgroup-item">
                        <input type="radio" name="text_or_multi" value="2" class="form-selectgroup-input" <?php echo e(old('text_or_multi', '1') == '2' ? 'checked' : ''); ?>>
                        <span class="form-selectgroup-label">Large Image</span>
                    </label>
                    <label class="form-selectgroup-item">
                        <input type="radio" name="text_or_multi" value="3" class="form-selectgroup-input" <?php echo e(old('text_or_multi', '1') == '3' ? 'checked' : ''); ?>>
        ...
        <div class="form-group mb-3">
            ...
            <textarea class="form-control" name="message" data-toggle="autosize" placeholder="Typing something…" style="height:150px;"><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\1-websites\wp.mintservice.ltd\resources\views/admin/notification.blade.php ENDPATH**/ ?>